...
prompt Created by wilamows on ιεν ωπι 27 ξΰι 2024
set feedback off
set define off
...
alter table DRIVER disable constraint SYS_C00711253;
prompt Disabling foreign key constraints for DELIVERY...
alter table DELIVERY disable constraint SYS_C00711286;
prompt Disabling foreign key constraints for FOODDELIVERY...
alter table FOODDELIVERY disable constraint SYS_C00711289;
prompt Disabling foreign key constraints for SUPPLYSDELIVERY...
alter table SUPPLYSDELIVERY disable constraint SYS_C00711294;
prompt Disabling foreign key constraints for COMMUNITYMEMBER...
alter table COMMUNITYMEMBER disable constraint SYS_C00711300;
alter table COMMUNITYMEMBER disable constraint SYS_C00711301;
alter table COMMUNITYMEMBER disable constraint SYS_C00711302;
alter table COMMUNITYMEMBER disable constraint SYS_C00711303;
prompt Disabling foreign key constraints for BIRTH...
alter table BIRTH disable constraint SYS_C00711315;
...
alter table DRIVER enable constraint SYS_C00711253;
prompt Enabling foreign key constraints for DELIVERY...
alter table DELIVERY enable constraint SYS_C00711286;
prompt Enabling foreign key constraints for FOODDELIVERY...
alter table FOODDELIVERY enable constraint SYS_C00711289;
prompt Enabling foreign key constraints for SUPPLYSDELIVERY...
alter table SUPPLYSDELIVERY enable constraint SYS_C00711294;
prompt Enabling foreign key constraints for COMMUNITYMEMBER...
alter table COMMUNITYMEMBER enable constraint SYS_C00711300;
alter table COMMUNITYMEMBER enable constraint SYS_C00711301;
alter table COMMUNITYMEMBER enable constraint SYS_C00711302;
alter table COMMUNITYMEMBER enable constraint SYS_C00711303;
prompt Enabling foreign key constraints for BIRTH...
alter table BIRTH enable constraint SYS_C00711315;
