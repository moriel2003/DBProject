...
prompt Created by wilamows on ιεν ωπι 24 ιεπι 2024
set feedback off
set define off
...
alter table DRIVER disable constraint SYS_C00718436;
prompt Disabling foreign key constraints for DELIVERY...
alter table DELIVERY disable constraint SYS_C00718441;
prompt Disabling foreign key constraints for FOODDELIVERY...
alter table FOODDELIVERY disable constraint SYS_C00718444;
prompt Disabling foreign key constraints for SUPPLYSDELIVERY...
alter table SUPPLYSDELIVERY disable constraint SYS_C00718449;
prompt Disabling foreign key constraints for COMMUNITYMEMBER...
alter table COMMUNITYMEMBER disable constraint SYS_C00718455;
alter table COMMUNITYMEMBER disable constraint SYS_C00718456;
alter table COMMUNITYMEMBER disable constraint SYS_C00718457;
alter table COMMUNITYMEMBER disable constraint SYS_C00718458;
prompt Disabling foreign key constraints for BIRTH...
alter table BIRTH disable constraint SYS_C00718464;
...
values (100, 'delivered', to_date('07-02-2000', 'dd-mm-yyyy'), to_date('12-10-2000', 'dd-mm-yyyy'), 1000000000);
insert into DELIVERY (deliverynum, status, deliverydate, deliveryfinisheddate, phonenum)
...
insert into DELIVERY (deliverynum, status, deliverydate, deliveryfinisheddate, phonenum)
values (122, 'delivered', to_date('16-03-2000', 'dd-mm-yyyy'), to_date('10-10-2000', 'dd-mm-yyyy'), 1000000022);
insert into DELIVERY (deliverynum, status, deliverydate, deliveryfinisheddate, phonenum)
...
insert into DELIVERY (deliverynum, status, deliverydate, deliveryfinisheddate, phonenum)
values (1, 'sent', to_date('01-07-2000', 'dd-mm-yyyy'), to_date('01-07-2000', 'dd-mm-yyyy'), 1000000021);
insert into DELIVERY (deliverynum, status, deliverydate, deliveryfinisheddate, phonenum)
values (0, 'sent', to_date('10-12-2000', 'dd-mm-yyyy'), to_date('10-12-2000', 'dd-mm-yyyy'), 1000000002);
insert into DELIVERY (deliverynum, status, deliverydate, deliveryfinisheddate, phonenum)
...
insert into FOODDELIVERY (mealdescription, kashrus, typedm, deliverynum)
values ('VERY GOOD', 'RABANUT', 'M', 0);
insert into FOODDELIVERY (mealdescription, kashrus, typedm, deliverynum)
values ('Vegetarian Meal', 'Kosher', 'M', 1);
insert into FOODDELIVERY (mealdescription, kashrus, typedm, deliverynum)
...
alter table DRIVER enable constraint SYS_C00718436;
prompt Enabling foreign key constraints for DELIVERY...
alter table DELIVERY enable constraint SYS_C00718441;
prompt Enabling foreign key constraints for FOODDELIVERY...
alter table FOODDELIVERY enable constraint SYS_C00718444;
prompt Enabling foreign key constraints for SUPPLYSDELIVERY...
alter table SUPPLYSDELIVERY enable constraint SYS_C00718449;
prompt Enabling foreign key constraints for COMMUNITYMEMBER...
alter table COMMUNITYMEMBER enable constraint SYS_C00718455;
alter table COMMUNITYMEMBER enable constraint SYS_C00718456;
alter table COMMUNITYMEMBER enable constraint SYS_C00718457;
alter table COMMUNITYMEMBER enable constraint SYS_C00718458;
prompt Enabling foreign key constraints for BIRTH...
alter table BIRTH enable constraint SYS_C00718464;
